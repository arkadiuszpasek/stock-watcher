...
- **Docker** hosted on this vps running containers:
  ...
  - **Jenkins** installed on EC2, getting the webhook when commit is pushed to master branch in this repo, then deploying the changes in docker containers
### Project information
...
You can start the backend api on your local machine, but you would probably need to change the way it establishes connection with MongoDB.
